...
Template.notebook_template.events({
  ...
  'click .e_sendPages'(event, instance){
    ...
    var code =   Session.get("accessToken");
    var questions = [];
    questions.push(new QuestionObject("1","What is the time?"));
    questions.push(new QuestionObject("2","question 2?"));
    Meteor.call('sendPageToStudents', code, this._id, questions);
  },
...
function QuestionObject(questionIndex, questionAnswer) {
